    ...
    <div className="max-w-xl space-y-8">
      ...
      {isDemo ? (
        <section className="rounded-2xl border border-stone-100 bg-white shadow-[0_1px_2px_rgba(35,40,31,0.04),0_12px_28px_-16px_rgba(35,40,31,0.18)] p-4">
          <h2 className="font-medium text-stone-800 mb-1">Canvas / Gradescope / PrairieLearn</h2>
          <p className="text-sm text-stone-500">
            Connecting a real account is disabled on this public demo - a stranger's real Canvas
            token or Gradescope/PrairieLearn session has no business landing on a shared instance
            anyone can reach. This works exactly as shown when you run Prioriton yourself; see the
